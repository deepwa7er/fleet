...
//   VPS (tailnet) : http://deepwa7er.tailcfab97.ts.net:8090   (plain HTTP — the
//                   tailnet encrypts transport; reachable from any tailnet device)
//   local dev     : http://127.0.0.1:8090
//
// Whatever you put here must also be listed in manifest.json `host_permissions`.
window.HARBOR = {
  api: "http://deepwa7er.tailcfab97.ts.net:8090",
};
