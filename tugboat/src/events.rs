...
//!
//! Nothing reads it yet. It is the emitter half of depot, the fleet's data
//! warehouse, in the same shape as breakwater's access log: emit the fact now,
//! ingest it when depot exists.
//!
